...
class WebsiteController extends Controller
{
    public function __construct() {
        $this->data['currentAdminMenu'] = 'website';
    }
    public function index()
    {
        $this->data['currentAdminSubMenu'] = 'website_meteri';
        $user =  \Auth::user();
        $this->data['trainings'] = Training::where('type_training', 'website')->orderBy('tahun', 'ASC')->paginate(10);
    ...
    public function create()
    {
        ...
        return view('admin.website.form', $this->data);
    }
    ...
    public function materi_index($id)
    {
        ...
        return view('admin.website.materi.index', $this->data);
    } 
    public function materi_create($id)
    {
        ...
        $this->data['id'] = $id;
         ...
         return view('admin.website.materi.form', $this->data);
    }
    ...
    public function materi_store(Request $request ,$id)
    {
        ...
        return redirect('admin/website/materi/'.$id);
    }
    ...
    public function materi_update(Request $request, string $id)
    {
        ...
        return redirect('admin/website/materi/'. $product->training_id);
    }
    ...
    public function video($id)
    {
        ...
        return view('admin.website.materi.video.index', $this->data);
    } 
    public function video_create($id)
    {
        ...
        return view('admin.website.materi.video.form', $this->data);
    }
    public function video_store(Request $request ,$id)
    {
        ...
        return redirect('admin/website/materi/video/'.$id);
    }
    ...
    public function video_update(Request $request, string $id)
    {
        ...
        return redirect('admin/website/materi/video/'. $product->training_id);
    }
}
