...
class MobileController extends Controller
{
    public function __construct() {
        $this->data['currentAdminMenu'] = 'mobile';
    }
    public function index()
    {
        $this->data['currentAdminSubMenu'] = 'mobile_meteri';
        $user =  \Auth::user();
        $this->data['trainings'] = Training::where('type_training', 'mobile')->orderBy('tahun', 'ASC')->paginate(10);
    ...
    public function create()
    {
        ...
        return view('admin.mobile.form', $this->data);
    }
    ...
    {
        if (empty($id)) {
            return redirect('admin/mobile/create');
        }
        $this->data['currentAdminSubMenu'] = 'mobile_meteri';
        $tahunSekarang = date('Y');
        for ($i = $tahunSekarang; $i <= ($tahunSekarang + 3); $i++) {
    ...
    public function materi_index($id)
    {
        ...
        return view('admin.mobile.materi.index', $this->data);
    } 
    public function materi_create($id)
    {
        ...
        $this->data['id'] = $id;
         ...
         return view('admin.mobile.materi.form', $this->data);
    }
    ...
    public function materi_store(Request $request ,$id)
    {
        ...
        return redirect('admin/mobile/materi/'.$id);
    }
    ...
    public function materi_update(Request $request, string $id)
    {
        ...
        return redirect('admin/mobile/materi/'. $product->training_id);
    }
    ...
    public function video($id)
    {
        ...
        return view('admin.mobile.materi.video.index', $this->data);
    } 
    public function video_create($id)
    {
        ...
        return view('admin.mobile.materi.video.form', $this->data);
    }
    public function video_store(Request $request ,$id)
    {
        ...
        return redirect('admin/mobile/materi/video/'.$id);
    }
    ...
    public function video_update(Request $request, string $id)
    {
        ...
        return redirect('admin/mobile/materi/video/'. $product->training_id);
    }
}
