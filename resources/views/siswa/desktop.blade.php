        ...
        <nav class="bg-dark">
            <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div class="flex h-[70px] justify-between items-center ">
                    ...
                    <h1 class="text-2xl font-semibold text-white uppercase">Industrial Class - <span
                ...
                <div class="flex-none h-full">
                    ...
                    <div
                        ...
                        <div class="mt-[20px] text-grays flex-grow">
                            <ul style="height: 400px" id="sidebar" class="w-full overflow-y-scroll flex flex-col h-[360px]">
