    ...
    <div id="app" class="hidden">
        <nav class="bg-dark">
            <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div class="flex h-[70px] justify-between items-center ">
                    ...
                    <h1 class="text-2xl font-semibold text-white uppercase">Upskilling Class - <span
                            class="text-[#E0B453]">Desktop Software</span></h1>
        ...
        <div class="mx-auto max-w-7xl my-auto px-2 sm:px-6 lg:px-8 mt-4">
            <div class="flex flex-row text-white rounded-b-[20px] gap-5">
                    ...
                    <div
                        ...
                        <div class="mt-[20px] text-grays flex-grow">
                            ...
                            @forelse ($products as $product)
                                <a href="{{ url('/alsav/dashboard/desktop-software/' . $product->id ) }}" class="flex">
                                    <div class="mr-[10px] w-[4px] {{ ($product->id == $tes) ? 'actives' : ''}} flex-none"></div>
                                    <li
                                        class="px-[20px] py-[10px] {{ ($product->id == $tes) ? 'active' : ''}} shrink w-72 flex-initial border-b-[1.5px] mb-[5px] hover:rounded-l-lg border-gray-300 hover:text-white hover-bg-dark transition-all delay-300 duration-100">
                                        {{ $product->hari }}</li>
                                </a>
                                @empty
                ...
                <div id="right-app"
                    class="flex-1">
                    <div id="videos" class="flex flex-wrap overflow-auto h-[550px] flex-shrink-0 items-center self-stretch justify-around">
                        ...
                        <div class="mb-3">
                            <div class="youtube-player pristine" data-video-id="{{ $picture->video }}">
                                ...
                                <p class="text-dark text-center font-bold">{{ $picture->title }}</p>
                        </div>
                        @empty
                            No records found
                        @endforelse 
