    ...
    <div id="app" class="hidden">
        ...
        <nav class="bg-dark">
            <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                <div class="flex h-[70px] justify-between items-center ">
                    ...
                    <h1 class="text-2xl font-semibold text-white uppercase">Upskilling Class</h1>
        ...
        <div class="mx-auto max-w-7xl my-auto px-2 sm:px-6 lg:px-8">
            <div
                ...
                <a href="{{ route('guru.desktop') }}" id="item-2" class="items delay-100 w-full hover:scale-110 transition-all duration-100 
                ease-out">
