...
<body>
    ...
    <div id="app" class="hidden">
        ...
        <nav class="bg-dark">
            <div class="mx-auto max-w-7xl px-2 sm:px-6 xl:px-8">
                <div class="flex h-[70px] justify-between items-center ">
                    ...
                    <h1 class="text-2xl font-semibold text-white uppercase">Training Class</h1>
        ...
        <div class="w-full gap-5 flex-wrap space-y-5 md:space-y-0 md:inline-flex p-10 2xl:py-44 justify-center items-start">
            ...
            {{-- Website --}}
            <a href="" id="card-1" class="w-full h-80 md:h-60 md:w-80 2xl:h-96 p-5 rounded-2xl hover:shadow-custom flex-col justify-between items-start inline-flex hover:scale-105 duration-300 ease-in-out">
            ...
            {{-- Desktop Software --}}
            <a href="" id="card-2" class="w-full h-80 md:h-60 md:w-80 2xl:h-96 p-5 rounded-2xl hover:shadow-custom flex-col justify-between items-start inline-flex hover:scale-105 duration-300 ease-in-out">
            ...
            {{-- Mobile App --}}
            <a href="" id="card-3" class="w-full h-80 md:h-60 md:w-80 2xl:h-96 p-5 rounded-2xl hover:shadow-custom flex-col justify-between items-start inline-flex hover:scale-105 duration-300 ease-in-out">
            ...
            {{-- A.I Software --}}
            <a href="" id="card-4" class="w-full h-80 md:h-60 md:w-80 2xl:h-96 p-5 rounded-2xl hover:shadow-custom flex-col justify-between items-start inline-flex hover:scale-105 duration-300 ease-in-out">
            ...
            {{-- UI/UX with Figma --}}
            <a href="" id="card-5" class="w-full h-80 md:h-60 md:w-80 2xl:h-96 p-5 rounded-2xl hover:shadow-custom flex-col justify-between items-start inline-flex hover:scale-105 duration-300 ease-in-out">
            ...
            {{-- Codekidz --}}
            <a href="#" id="card-6" class="w-full h-80 md:h-60 md:w-80 2xl:h-96 p-5 rounded-2xl ring-2 hover:ring-0 hover:shadow-custom flex-col justify-between items-start inline-flex hover:scale-105 duration-300 ease-in-out">
