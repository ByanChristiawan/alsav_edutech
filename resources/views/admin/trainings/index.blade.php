        ...
        <div class="col-lg-12">
            <div class="card card-default">
                    ...
                    <table class="table table-bordered table-stripped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $training->hari }}</td>
                                <td>
                                <a href="{{ url('admin/trainings/materi/'. $training->id) }}"
                                        class="btn btn-warning btn-sm">materi</a>
                                    <a href="{{ url('admin/trainings/'. $training->id .'/edit') }}"
                                        class="btn btn-warning btn-sm">edit</a>

                                    {!! Form::open(['url' => 'admin/trainings/'. $training->id, 'class' => 'delete',
                ...
                <div class="card-footer text-right">
                    <a href="{{ url('admin/trainings/create') }}" class="btn btn-primary">Add New</a>
                </div>
            </div>
        </div>
    </div>
