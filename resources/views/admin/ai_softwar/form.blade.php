        ...
        <div class="col-lg-6">
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    @if (!empty($products))
                    {!! Form::model($products, ['url' => ['admin/ai_softwar', $products->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
                    {!! Form::hidden('id') !!} 
                    @else
                    
                    {!! Form::open(['url' => 'admin/ai_softwar/add', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    @endif
