        ...
        <div class="col-lg-12">
            <div class="card card-default">
                    ...
                    <table class="table table-bordered table-stripped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('storage/'.$materi->thumbnail) }}" width="100" height="auto" />
                                </td>
                                <td>
                                    <a href="{{ url('admin/ai_softwar/materi/video/'. $materi->id .'/edit') }}"
                                        class="btn btn-warning btn-sm">edit</a>

                                    {!! Form::open(['url' => 'admin/ai_softwar/materi/'. $materi->id, 'class' => 'delete',
                ...
                <div class="card-footer text-right">
                    <a href="{{ url('admin/ai_softwar/materi/create/video/' . $id) }}" class="btn btn-primary">Add New</a>
                </div>
            </div>
        </div>
    </div>
