        ...
        <div class="col-lg-12">
            <div class="card card-default">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('admin/ai_softwar/materi/video/'. $training->id) }}"
                                        class="btn btn-info btn-sm">materi</a>
                                            @else
                                            <a href="{{ url('admin/ai_softwar/materi/'. $training->id) }}"
                                        class="btn btn-success btn-sm">materi</a>
                                    @endif
                                    
                                
                                    <a href="{{ url('admin/ai_softwar/'. $training->id .'/edit') }}"
                                        class="btn btn-warning btn-sm">edit</a>

                                    {!! Form::open(['url' => 'admin/ai_softwar/'. $training->id, 'class' => 'delete',
                ...
                <div class="card-footer text-right">
                    <a href="{{ url('admin/ai_softwar/create') }}" class="btn btn-primary">Add New</a>
                </div>
            </div>
        </div>
    </div>
