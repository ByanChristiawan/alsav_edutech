        ...
        <div class="col-lg-12">
            <div class="card card-default">
                    ...
                    <table class="table table-bordered table-stripped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/website/materi/video/'. $materi->id .'/edit') }}"
                                        class="btn btn-warning btn-sm">edit</a>

                                    {!! Form::open(['url' => 'admin/website/materi/'. $materi->id, 'class' => 'delete',
                ...
                <div class="card-footer text-right">
                    <a href="{{ url('admin/website/materi/create/video/' . $id) }}" class="btn btn-primary">Add New</a>
                </div>
            </div>
        </div>
    </div>
