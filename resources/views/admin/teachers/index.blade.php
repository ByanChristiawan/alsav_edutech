        ...
        <div class="col-lg-12">
            <div class="card card-default">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('admin/trainings/materi-tc/video/'. $training->id) }}"
                                        class="btn btn-info btn-sm">materi</a>
                                            @else
                                            <a href="{{ url('admin/trainings/materi-tc/'. $training->id) }}"
                                        class="btn btn-success btn-sm">materi</a>
                                    @endif
                                    
                                
                                    <a href="{{ url('admin/trainings/'. $training->id .'/edit2') }}"
                                        class="btn btn-warning btn-sm">edit</a>

                                    {!! Form::open(['url' => 'admin/trainings2/'. $training->id, 'class' => 'delete',
                ...
                <div class="card-footer text-right">
                    <a href="{{ url('admin/trainings/create2') }}" class="btn btn-primary">Add New</a>
                </div>
            </div>
        </div>
    </div>
