        ...
        <div class="col-lg-12">
            <div class="card card-default">
                    ...
                    <table class="table table-bordered table-stripped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/trainings/materi/video/'. $materi->id .'/edit2') }}"
                                        class="btn btn-warning btn-sm">edit</a>

                                    {!! Form::open(['url' => 'admin/trainings2/materi/'. $materi->id, 'class' => 'delete',
                ...
                <div class="card-footer text-right">
                    <a href="{{ url('admin/trainings/materi/create2/video/' . $id) }}" class="btn btn-primary">Add New</a>
                </div>
            </div>
        </div>
    </div>
